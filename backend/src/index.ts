export default {
  ...
  async bootstrap({ strapi }: { strapi: any }) {
    try {
      // In production, permissions should be managed via Admin Panel or Config Sync.
      // In development/staging, ensure default roles and permissions are bootstrapped.
